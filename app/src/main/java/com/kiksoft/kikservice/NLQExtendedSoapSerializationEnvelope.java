...
public class NLQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    
    static {
        classNames.put("urn:DefaultNamespace^^HATA",NLQHATA.class);
        classNames.put("urn:DefaultNamespace^^KULLANICI_DOGRULAMARETURN",NLQKULLANICI_DOGRULAMARETURN.class);
        classNames.put("urn:DefaultNamespace^^TUM_DOSYALARI_GETIR_SORGUSU",NLQTUM_DOSYALARI_GETIR_SORGUSU.class);
        classNames.put("urn:DefaultNamespace^^DOSYA_BILGISI",NLQDOSYA_BILGISI.class);
        classNames.put("urn:DefaultNamespace^^TUM_DOSYA_LISTESI_GETIRRETURN",NLQTUM_DOSYA_LISTESI_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^TALEP_BILGISI",NLQTALEP_BILGISI.class);
        classNames.put("urn:DefaultNamespace^^TALEP_LISTESI_GETIRRETURN",NLQTALEP_LISTESI_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^TALEP_BOLREQUEST",NLQTALEP_BOLREQUEST.class);
        classNames.put("urn:DefaultNamespace^^TALEP_ISLEMIRETURN",NLQTALEP_ISLEMIRETURN.class);
        classNames.put("urn:DefaultNamespace^^DTEMIN_IHALE_BILGISI",NLQDTEMIN_IHALE_BILGISI.class);
        classNames.put("urn:DefaultNamespace^^DTEMIN_IHALE_LISTESI_GETIRRETURN",NLQDTEMIN_IHALE_LISTESI_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^TEKLIF",NLQTEKLIF.class);
        classNames.put("urn:DefaultNamespace^^DTEMIN_IHALE_DETAY_GETIRRETURN",NLQDTEMIN_IHALE_DETAY_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^SOZLESME_DETAYI",NLQSOZLESME_DETAYI.class);
        classNames.put("urn:DefaultNamespace^^SOZLESME_LISTESI_GETIRRETURN",NLQSOZLESME_LISTESI_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^SIPARIS_BILGISI",NLQSIPARIS_BILGISI.class);
        classNames.put("urn:DefaultNamespace^^SIPARIS_LISTESI_GETIRRETURN",NLQSIPARIS_LISTESI_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^IS_ARTIS",NLQIS_ARTIS.class);
        classNames.put("urn:DefaultNamespace^^IS_ARTIS_LISTESI_GETIRRETURN",NLQIS_ARTIS_LISTESI_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^KALEM",NLQKALEM.class);
        classNames.put("urn:DefaultNamespace^^IHTIYAC_LISTESI_KALEMLERI_GETIRRETURN",NLQIHTIYAC_LISTESI_KALEMLERI_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^DOSYA", NLQDosya.class);
        classNames.put("urn:DefaultNamespace^^EK_DOSYA_BILGISI_GETIRRETURN",NLQEK_DOSYA_BILGISI_GETIRRETURN.class);
        classNames.put("urn:DefaultNamespace^^TALEP_KALEM_ALIM_YAPILACAKREQUEST",NLQTALEP_KALEM_ALIM_YAPILACAKREQUEST.class);
        classNames.put("urn:DefaultNamespace^^TALEP_KALEM_ALIM_YAPILMAYACAKREQUEST",NLQTALEP_KALEM_ALIM_YAPILMAYACAKREQUEST.class);
    } 

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public NLQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NLQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NLQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NLQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NLQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NLQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
